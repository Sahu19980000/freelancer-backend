            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Create Premium Plan</h4>
                    </div>
                    {{-- <div class="text-start">
                        <a href="{{ route('subcategory.index') }}" class="btn btn-primary btn-sm ms-4" id="addRow">Back</a>
                    </div> --}}
                    {{-- <hr /> --}}
                    <form action="{{ route('premiumplanmake/store') }}" method="POST" id="makeplan" enctype="multipart/form-data" class="form theme-form dark-inputs">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $('#add_rowA').on('click', function() {
                ...
                row_countA++;
                var content =
                 '<tr id="rowA'+row_countA+'"><td><input type="text" class="form-control" name="premium['+row_countA+'][items]" id="premium'+row_countA+'"></td><td><a href="javascript:void(0);" class="remove_row text-danger" data-row="'+row_countA+'"><i class="fa fa-trash"></i></a></td></tr>';
