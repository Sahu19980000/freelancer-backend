            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit/Update Client User</h4>
                    </div>
                    <div class="text-start">
                        <a href="{{ route('clientusers.index') }}" class="btn btn-primary btn-sm ms-4" id="addRow">Back</a>
                    </div>
                    <hr />
                    <form method="POST" id="quickForm" enctype="multipart/form-data"
                        action="{{ route('clientusers.update', $clientuser->id) }}">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control btn-pill" name="client_name"
                                            id="exampleFormControlInput5" type="text" placeholder="Enter Name" value="{{$clientuser->name}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlInput5">Email</label>
                                        <input class="form-control btn-pill" name="client_email"
                                            id="exampleFormControlInput5" type="email" placeholder="Enter Email Address" value="{{$clientuser->email}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select input-air-primary digits" id="exampleFormControlSelect17"
                                            ...
                                            <option value="{{$clientuser->joinas}}" selected>{{$clientuser->joinas}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select input-air-primary digits" id="exampleFormControlSelect17"
                                            ...
                                            <option value="{{$clientuser->country}}">{{$clientuser->country}}</option>
