    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('basicplanmake.create') }}" class="btn btn-primary mb-3" id="addRow">Add New</a>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit mt-2"> <a
                                                            href="{{ route('advanceplanmake/edit', $data->id) }}"><i
                                                                class="fa fa-pencil-square-o"
                                                                style="font-size: 20px;"></i></a>
                                                    </li>

                                                    <form method="POST" action="{{ route('advanceplanmake/destroy', $data->id) }}"
