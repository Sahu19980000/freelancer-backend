...
<head>
    ...
    <style>
        body {
            background-image: url('https://wallpapers.com/images/hd/consultant-group-meeting-ir1qvac70n327ksm.jpg');
                        ...
                        <div class="login-main">
                            <form method="POST" action="{{ route('login') }}" class="theme-form">
                                ...
                                <div class="form-group form-input">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror" name="email"
                                        value="{{ old('email') }}" required autocomplete="email" placeholder="admin@gmail.com" autofocus>
                                </div>
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
