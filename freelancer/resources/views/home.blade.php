                        ...
                        <div class="card boost-up-card overflow-hidden">
                            <div class="p-4">
                                ...
                                <div class="img-boostup"><img class="img-boostup-img-1"
                                        ...
                                        class="img-boostup-img-2" src="{{ asset('assets/images/dashboard-3/boostup2.png')}}"
                                        alt="boostup">
                                </div>
                                    ...
                                    <table class="percentage-data w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="f-light f-12 f-w-500" scope="col">
                                                    Percentage</th>
                                                <th class="f-light f-12 f-w-500 text-end" scope="col">
                                                    Total Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <ul>
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('/assets/images/dashboard-3/product/1.png')}}" alt="product"></div>
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('/assets/images/dashboard-3/product/2.png')}}" alt="product"></div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('/assets/images/dashboard-3/product/3.png')}}" alt="product"></div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                ...
                                <li class="d-flex top-product gap-2">
                                    <div><img class="img-fluid product-img"
                                            src="{{ asset('/assets/images/dashboard-3/product/4.png') }}" alt="product"></div>
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                                ...
                                                <div class="dropdown">
                                                    <div id="dropdownMenuButtonicon31" data-bs-toggle="dropdown"
                                                        ...
                                                        <svg class="invoice-icon">
                                                            <use href="{{ asset('/assets/svg/icon-sprite.svg#more-vertical') }}">
                                                            </use>
                                                        </svg>
                                                    </div>
                                                    <div class="dropdown-menu dropdown-menu-end"
                                                ...
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                ...
                                                                src="{{ asset('/assets/images/user/50.png" alt="user') }}"><a
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('/assets/images/user/51.png') }}" alt="user"><a
                                                                class="f-10 f-w-500 username"
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('/assets/images/user/33.png') }}" alt="user"><a
                                                                class="f-10 f-w-500 username"
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('/assets/images/user/52.png') }}" alt="user"><a
                                                                class="f-10 f-w-500 username"
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('/assets/images/user/53.png') }}" alt="user"><a
                                                                class="f-10 f-w-500 username"
                                            ...
                                            <div class="team-activity">
                                                <div class="activity-data d-flex align-items-center gap-3">
                                                    <div class="common-space gap-2 ">
                                                        <div class="user-activity me-3"><img
                                                                class="rounded-circle p-1 img-fluid me-3 img-50"
                                                                src="{{ asset('/assets/images/user/54.png') }}" alt="user"><a
                                                                class="f-10 f-w-500 username"
